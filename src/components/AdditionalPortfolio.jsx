        ...
        <div className="flex flex-col flex-1 gap-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-1/2">
              <PortfolioImage src={images[1]} alt="Portfolio 2" index={1} portfolioType="portfolio4" />
            </div>
            <div className="w-full md:w-1/2">
              <PortfolioImage src={images[2]} alt="Portfolio 3" index={2} portfolioType="portfolio4"/>
            </div>
          </div>
          <div>
            <PortfolioImage src={images[3]} alt="Portfolio 4" index={3} portfolioType="portfolio4"/>
          </div>
        </div>
